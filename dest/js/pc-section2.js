...

{
  ...
  const words = [
    'Computer','Fußball','Geld','Geldbörse','Handy',
    'Auto','Bleistift','Buch','Wohnung',
    'Fahrrad','Flugzeug','Motorrad','Radiergummi',
    'Schere','Schiff','Zug',
  ]
  ...
  function setQuiz(){
      ...
      target.value = '';
      const images = [
        'img/Computer.png','img/Fußball.png','img/Geld.png','img/encoded1.png','img/Handy.png',
        'img/Auto.png','img/Bleistift.png','img/Buch.png','img/Wohnung.png',
        'img/Fahrrad.png','img/Flugzeug.png','img/Motorrad.png','img/Radiergummi.png',
        'img/Schere.png','img/Schiff.png','img/Zug.png',
      ];
      let img;
      img = `img/${word}.png`;
      question.src = img;
